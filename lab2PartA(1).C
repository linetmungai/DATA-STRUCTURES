...
int main() {
    ...
    Student s1("REG123", "LINET", 19);
    Student s2("REG456", "SIMON", 22);
    Student s3("REG789", "JAMES", 23);

    studentList.add(s1);
    studentList.add(s2);
    studentList.addAt(s3, 1);  // Insert Charlie at position 1
    ...
    studentList.removeAt(0); // Remove Alice by position
